...
function restart(){ //restarts the story when clicked
    storymark = 0;
    startmus.play();
...
function optionclick(opnum){
    ...
    case 0:
        if(opnum === 1){
            resettext();
            showText("You enter the submarine followed by your 2 crewmates; the door closes behind you. There is a long metal hallway, pipes and doors run along the walls and ceiling, before disappearing into the various branching hallways. At the end lies the control room which pilots the sub. ", 0, 15, "story");
            ...
            resettext();
            showText("Before entering the submarine and departing on a week's long journey. You decide to take a final look around, absorbing the last of dray land you will see for a while. There is an old wooden pier that the submarine is tied to, boards worn from years of exposure to the elements it ends a few meters away. The submarine itself is a brass colour, reflecting the sun, a ladder to the roof sits next to the entrance hatch.", 0, 15, "story");
            ...
            resettext();
            showText(" Looking to either side you can tell there is a sense of nervousness in the three of you. A tension that needs to be delt with before beginning the weeks-long journey into the depths of the sea. It is sure to bring dangers and compilations that you could not prepare for. Your crewmates glance at your way waiting for you to break the silence.", 0, 15, "story");
    ...
    case 1: //what happens if option 1 is clicked 1st
        if(opnum === 2){
            ...
            resettext();
            showText("Turning down the closest corridor, it is a short corridor leading to a rounded doorway. Going through leads to a laboratory, various machines and tools are placed into shelves along the walls. In there is countertop taking up most of the center of the room, in the middle of it is various glass container. Some contained water, in preparation for various sea creatures, others have plants, leaves trying to escape their enclosures.", 0, 15, "story");
    ...
    case 2: // what happends when option 2 is clicked 1st
        ...
        if(opnum === 1){
            ...
            resettext();
            showText("You walk the final few meters to the end of the pier. Taking a deep breath, the sound of the ocean is peaceful, and the sun warms your back. Looking around you hear an ominous creak followed by a crack, as the wooden board you are standing on breaks underneath you. It's age finally catching up. A shocked yell escapes you as you find gravity taking hold.", 0, 15, "story");
    ...
    case 3: // what happends when option 3 is clicked 1st
        ...
        if(opnum === 1){
            resettext();
            showText("Taking a deep breath, you say ‘We have dedicated years of our life to this submarine, the next few weeks will feel like nothing compared to that.’ Your friends chuckle and relax a bit. You smile, the tension has been broken one of them responds. ‘The hardest part will be not killing each other over the next few we.....’ They stop suddenly.  ", 0, 15, "story");
...
// 3rd and final choice
    ...
    case 5:
        resettext();
        showText("You tap your finger on one of the empty tanks that is filled with water. There is a disturbance of sand in the bottom of the tank. You realise it is not actually empty, there is a creature burrowed in the stand that is emerging. It has many spindly legs and a long flat body. Its eyes swivel on stalks and lock on to your eyes, you feel dizzy and then nothing else.", 0, 15, "story");
        op2.style.display = "none";
    ...
    case 6:
        resettext();
        showText("To your shock the seagull responds. Your ears hear a typical seagull squark, but you brain hears a voice. ‘Salutations human, weird boat you have’. You scramble back in shock, the gull squarks again this time no psychic voice echos and it flies off. Shaken by the experience you climb down the ladder and get ready to depart.", 0, 15, "story");
        op3.style.display = "none";
    ...
    case 9:
        resettext();
        showText("Your crewmates respond simultaneously. ‘You will not be making it to the deep sea, humanities plans of exploration were doomed from the start.’ Tentacles start emerging from their mouths. You try to sprint away but find you are rooted to the ground. They continue, ‘You will enter the vessel with us, and you will never be seen again.’ You begin walking against your will into the submarine and the hatch closes behind the 3 of you.", 0, 15, "story");
        op1.style.display = "none";
        dooraud.play();
